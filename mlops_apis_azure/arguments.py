...
def arguments_function(input_params):
        """
        This function is used to generate the argument lists that needs to be passed during
        the creation of the training.py file and preprocessing.py file. Inputs are read from 
        the input_params dictionary. If you want to add any new arguments, you will have to 
        define it in here.

        Args :
                input_params : input parameter configurations
        Returns :
                argument_list : list of all the arguments that needs to be added, during
